<template>
            ...
            <div class="card-body">
              ...
              <form @submit.prevent="store" method="post">
                <div class="form-group">
                  <label for="title" class="font-weight-bold">Nama Barang</label>
                  <input type="text" class="form-control" v-model="post.nama_barang" placeholder="Masukkan nama barang">
                ...
                <div class="form-group">
                  <label for="title" class="font-weight-bold">Harga Barang</label>
                  <input type="text" class="form-control" v-model="post.harga_barang" placeholder="Masukkan harga barang">
  ...
  function store() {
    ...
    formData.append('harga_barang', post.harga_barang);
