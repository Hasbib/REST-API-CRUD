<template>
        ...
        <div class="col-md-12">
          <div class="card border-0 rounded shadow">
            <div class="card-body">
              ...
              <br>
              <button class="btn btn-sm btn-batal"><router-link to="../dashboard">BATAL</router-link></button>
            </div>
          </div>
        </div>
      </div>
  ...
  export default {
    setup() {
      ...
      // method update
      function update() {
        const { nama_barang, harga_barang, stok, deskripsi, foto } = post;
